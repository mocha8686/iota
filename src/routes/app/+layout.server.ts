...
const generateScavengePathname = (id: number | undefined) => id ? `/app/scavenge/${id}` : undefined;
...
export const load: LayoutServerLoad = async ({ locals, url }) => {
	...
	if (scavengePathname && url.pathname !== scavengePathname) redirect(302, scavengePathname);
